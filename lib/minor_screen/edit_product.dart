...
class _EditProductState extends State<EditProduct> {
  ...
  void pickProductImages() async {
    try {
      final pickedImages =
          await _picker.pickMultiImage(maxHeight: 300, maxWidth: 300, imageQuality: 95);
      setState(() {
  ...
  Future uploadImages() async {
    if (_formKey.currentState!.validate()) {
      ...
      MessengerHandler.showSnackBar(_scaffoldKey, 'please fill all fields');
    }
  }
  ...
  editProductData() async {
    await FirebaseFirestore.instance.runTransaction((transaction) async {
      DocumentReference documentReference =
          FirebaseFirestore.instance.collection('products').doc(widget.items['proid']);
      transaction.update(documentReference, {
        'maintecategory': mainCategValue,
                              ...
                              Column(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Center(child: Text(widget.items['maintecategory'])),
                                  )
                                ],
                              ),
                              Column(
